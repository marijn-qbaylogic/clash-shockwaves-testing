...
-- | Get a 'Translation' from a 'Value' using 'WSNormal' and precedence 11.
...
-- void type (assuming it has a custom bitpack implementation somehow)
...
displayShow = displayWith show (const WSNormal) precL
